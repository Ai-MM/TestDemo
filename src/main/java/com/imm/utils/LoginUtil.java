...
public class LoginUtil {
    ...
    public static void loadCookies(WebDriver driver) throws IOException {
        ...
        String fileName = URLDecoder.decode(FileUtil.getResource("cookies.yaml").getPath(), StandardCharsets.UTF_8);
    ...
    public static void loadLocalStorage(WebDriver driver) throws IOException {
        String line;
        JavascriptExecutor jsDriver = (JavascriptExecutor) driver;
        String fileName = URLDecoder.decode(FileUtil.getResource("localStorage.txt").getPath(), StandardCharsets.UTF_8);
